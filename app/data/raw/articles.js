const articles = [
  {
    id: 1,
    photo: require('../img/photo1.jpg'),
    type: 'article',
    time: -300,
    header: 'Plants Of Our Nature',
    text:
      'Ferns are a very old group of plants. They first appeared on Earth in the middle Devonian Era about 360 million years ago, just before the Carboniferous Era. Most of the modern fern families we see today first appeared in the Late Cretaceous about 45 or 50 million years ago – during the age of the dinosaurs!',
    comments: [
      {
        id: 1,
        text:
  ...
  {
    id: 2,
    photo: require('../img/photo2.jpg'),
    type: 'article',
    time: -1373,
    header: 'Balloon Trip',
    text:
      'Mostly it’s about hot air - for without that balloons are just big empty bags with baskets on the bottom. ' +
