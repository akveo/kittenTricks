...
export const CartIcon = (style: StyleType): React.ReactElement<ImageProps> => {
...
export const ForwardArrowIcon = (style: StyleType): React.ReactElement<ImageProps> => {
...
export const GridIcon = (style: StyleType): React.ReactElement<ImageProps> => {
...
export const MoreVerticalIcon = (style: StyleType): React.ReactElement<ImageProps> => {
